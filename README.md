...
- **Stat bars** — hunger / happiness / health rendered as progress bars
...
5. Keep committing — the pet eats.

> Want the pet to represent *you*? Edit `pet-state.json` (name, species) if you keep the repo private.
